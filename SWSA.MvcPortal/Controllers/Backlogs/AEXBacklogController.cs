...
[Route("backlogs/aex")]
public class AEXBacklogController(
AppDbContext db
) : BaseController
{
    private readonly DbSet<AEXBacklog> _backlogs = db.Set<AEXBacklog>();

    [Route("")]
    public async Task<IActionResult> AEXBacklogList()
    {
    ...
    [InternalAjaxOnly]
    [HttpPost("create")]
    public async Task<IActionResult> Create(AEXBacklog req)
    {
        _backlogs.Add(req);
    ...
    public async Task<IActionResult> Update([FromRoute] int id, AEXBacklog req)
    {
