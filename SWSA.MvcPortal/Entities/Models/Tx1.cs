...
public partial class Tx1
{
    ...
    public string? DatemgmtAccAvailbale { get; set; }
    ...
    public string? TaxCompuCa { get; set; }

    public string? FormC { get; set; }

    public string? DraftToClientSent { get; set; }

    public string? DraftToClientReceived { get; set; }
