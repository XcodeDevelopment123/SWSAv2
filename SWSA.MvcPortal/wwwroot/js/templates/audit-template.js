$(function () {
    ...
    flatpickr("#dateBilled,#auditStartDate,#asAtDate,#firstReviewSendDate,#firstReviewEndDate,#secondReviewSendDate,#secondReviewEndDate,#dateSentToKK,#dateReceivedAR,#dateOfReport,#dateOfDirectorsReport,#directorDateSent,#directorFollowUpDate,#directorDateReceived,#directorCommOfOathsDate,#taxDueDate,#datePassToTaxDept,#secSSMDueDate,#datePassToSecDept,#postAuditDateBinded,#postAuditDespatchDateToClient", {
        allowInput: true
    });
    ...
    $(document).on("click", ".edit-task", function () {
        ...
        $.ajax({
            url: `${urls.audit_template}/${taskId}`, // Update with your actual URL
            method: "GET",
            success: function (res) {
                if (res) {
                    editId = taskId;
    ...
    $(document).on("click", ".delete-task", function () {
        ...
        if (confirm("Are you sure you want to delete this task?")) {
            $.ajax({
                url: `${urls.audit_template}/${taskId}/delete`,
                method: "DELETE",
                success: function (res) {
