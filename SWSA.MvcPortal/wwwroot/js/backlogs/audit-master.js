$(function () {
    ...
    const taskFormInputs = {
        ...
        quarterToDoAudit: $taskForm.find('input[name="quarter"]'),
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res) {
                    ...
                    $taskForm.find('input[name="quarter"]').val(res.quarterToDoAudit);
                    $taskForm.find('input[name="activitySize"]').val(res.activitySize);
                    $taskForm.find('input[name="yearEndDate"]').val(ConvertTimeFormat(res.yearEndDate, "YYYY-MM-DD"));
                    $taskForm.find('input[name="yearToDo"]').val(res.yearToDo).trigger("change");
                    $taskForm.find('textarea[name="reason"]').val(res.reasonForBacklog);
